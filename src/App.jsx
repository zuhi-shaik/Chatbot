...
const App = () => {
  ...
  //const ai = new GoogleGenAI({ apiKey: "AIzaSyA6ZWGYlrTGc8nCl9_ZZqi4yfUW5eRaN-A" });
  ...
  const getResponse = async () => {
    ...
    // Force AI to always provide a source for financial questions
  ...
  return (
    <div>
      <Navbar />
      <div className="flex">
        <div className="w-[250px] bg-zinc-900 text-white p-4 h-[80vh] overflow-y-auto">
          ...
          {screen === 1 ? (
            <div className="screen-1 w-full h-[70vh] flex items-center justify-center flex-col">
              ...
              <div className="flex items-center gap-[15px] mt-5">
                <div className="card w-[200px] cursor-pointer bg-zinc-800 transition-all hover:bg-gray-800 rounded-lg p-[20px]" onClick={() => setScreen(2)}>
            ...
            <div className="screen-2 overflow-y-auto w-full h-[65vh] px-8">
